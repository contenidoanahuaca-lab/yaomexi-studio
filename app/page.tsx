  ...
  return (
    <>
        ...
        <div className="container-responsive flex flex-col gap-10 py-20 md:flex-row md:items-center">
          <div className="flex-1 space-y-6">
            ...
            <p className="max-w-xl text-lg text-neutral-100/90">
              Crea videos gratis para TikTok y pronto para YouTube; apoya
              reforestación con cada producto digital.
            </p>
          ...
          <div className="flex-1 rounded-3xl bg-white/10 p-8 shadow-xl shadow-brand-night/20 backdrop-blur-lg">
            <p className="text-sm uppercase tracking-[0.3em] text-brand-gold">
              Estrategia Yaomexicatl
            </p>
            <p className="mt-4 text-lg text-neutral-50/90">
              Cultura prehispánica, colibríes y reforestación se unen para crear
              una comunidad creativa que financia bosques nativos mediante
              cómics, videos, NFTs y transparencia radical.
            </p>
          </div>
        </div>
      </section>
      ...
      <section
        ...
        className="bg-neutral-50 dark:bg-brand-night"
      >
        <div className="container-responsive space-y-10">
          <div className="max-w-2xl">
            <h2
              id="como-funciona"
              className="font-display text-3xl text-brand-jade"
            >
              ¿Cómo funciona?
            </h2>
            <p className="mt-4 text-neutral-600 dark:text-neutral-300">
              Diseñamos una experiencia rápida para que tus contenidos inspiren
              acción climática en cuestión de minutos.
            </p>
          </div>
          <ol className="grid gap-6 md:grid-cols-3">
            {['Elige plantilla', 'Genera guion/voz', 'Publica y apoya'].map(
              (step, index) => (
                <li
                  key={step}
                ...
                >
                  ...
                  <h3 className="font-display text-xl text-brand-jade">
                    {step}
                  </h3>
                  <p className="text-sm text-neutral-600 dark:text-neutral-300">
                    {index === 0 &&
                      'Selecciona la historia visual ideal para TikTok o Reels.'}
                    {index === 1 &&
                      'Recibe un guion y voz listos para grabar o animar tu video.'}
                    {index === 2 &&
                      'Publica, comparte y destina las ganancias a la reforestación.'}
                  </p>
                </li>
              )
            )}
      ...
      <section
        aria-labelledby="tematicas"
        className="bg-white dark:bg-brand-night/80"
      >
        <div className="container-responsive space-y-8">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-neutral-600 dark:text-neutral-300">
              Nuestra biblioteca digital honra la biodiversidad y la memoria de
